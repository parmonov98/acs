...
class PageController extends Controller
{
    ...
    public function appeals()
    {
        ...
        return view('profile.appeals', compact('appeals'));
    }


    public function newAppeal(FormBuilder $formBuilder)
    {
        ...
        $appealForm = $formBuilder->createByArray(
            [
                [
                    'name' => 'appeal_name',
                    'type' => 'text',
                    'label' => 'Murojaat mavzusi/nomi',
                    'attr' => [
                        'placeholder' => 'Gaz tashkilotiga qayta ulanish muommosi',
                    ],
                ...
                [
                    ...
                    'attr' => [
                        'placeholder' => 'Muommoyingizni batafsil yozing.',
                    ]
                ],
                [
                    'name' => 'profile_submit',
        ...
        return view('profile.new_appeal', compact('appealForm'));
    }
